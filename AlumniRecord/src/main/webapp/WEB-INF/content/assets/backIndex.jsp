					...
					<li>
						<ul class="dropdown-menu-list scroller" style="height: 250px;">
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo">
									<img src="as${pageContext.request.contextPath}/assets/g/avatar1.jpg" alt=""/>
								</span>
								<span class="subject">
									<span class="from">
										Bob Nilson
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo">
									<img src="as${pageContext.request.contextPath}/assets/g/avatar2.jpg" alt=""/>
								</span>
								<span class="subject">
									<span class="from">
										Lisa Wong
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo">
									<img src="as${pageContext.request.contextPath}/assets/g/avatar3.jpg" alt=""/>
								</span>
								<span class="subject">
									<span class="from">
										Richard Doe
					...
					<div class="portlet solid bordered light-grey">
						...
						<div class="portlet-body">
							<div id="site_statistics_loading">
								<img src="${pageContext.request.contextPath}/assets/img/loading.gif" alt="loading"/>
							</div>
										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="${pageContext.request.contextPath}/assets/img/avatar.png" class="img-responsive"/>
													<div class="details">
														<div>
					...
					<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar img-responsive" alt="" src="${pageContext.request.contextPath}/assets/img/avatar1.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="${pageContext.request.contextPath}/assets/img/avatar2.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="${pageContext.request.contextPath}/assets/img/avatar3.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
